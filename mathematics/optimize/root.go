...
func fdjac1(fn Func, n int, x []float64, fvec []float64, fjac []float64, ldfjac, ml, mu int, epsfcn float64, wa1, wa2 []float64) {
...
func hybrd(fn Func, x, diag, fjac, r, qtf, wa1, wa2, wa3, wa4 []float64) int {
	var msum int
	var iwa []int
...
func Root(fn Func, x []float64) ([]float64, error) {
	n := len(x)
